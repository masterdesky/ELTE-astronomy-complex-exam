...
In the convective zone, the gas conducts heat and rises to the surface in convective currents, cools off at the surface, and sinks back down to pick up more heat, similar to the boiling of water in a pot. This process can be described by the Schwarzschild criterion for convection

$$
    - \frac{\mathrm{d}T}{\mathrm{d}h} < \frac{g}{C_{p}} \, ,
$$

where $T$ is the temperature, $h$ is the altitude, $g$ is the gravitational acceleration, and $C_{p}$ is the specific heat capacity at constant pressure. This criterion is based on the adiabatic temperature gradient,
which states that convection will occur if the actual temperature gradient in a star is steeper than the adiabatic temperature gradient. In the Sun, the convective zone extends from about $70\%$ of the solar radius to the photosphere.
...
## 3.4. Magnetic field of the Sun
The Sun's magnetic field plays a crucial role in shaping the solar system's space weather and driving many solar phenomena, including sunspots, solar flares, and coronal mass ejections. Understanding the Sun's magnetic field is therefore key to understanding the Sun itself and its effects on the Earth.

It is believed that the Sun's magnetic field is generated by a dynamo process in its interior, specifically within the convective zone. This dynamo process is driven by the differential rotation of the Sun and the convective motion of plasma in the outer third of the Sun, which generates electric currents and, in turn, magnetic fields. This is known as the solar dynamo.

The structure of the Sun's magnetic field is complex and changes over time. It has a roughly dipolar structure, similar to Earth's magnetic field, but it also has smaller, localized features, particularly in active regions. As the Sun rotates, its magnetic field is carried out through the solar system by the solar wind, a stream of charged particles emitted by the Sun. This causes the magnetic field to take on an Archimedean spiral structure, often referred to as the "Parker spiral," named after the solar astrophysicist Eugene Parker. This spiral structure extends well beyond the orbit of Pluto, marking the boundary of the Sun's magnetic influence or the "heliosphere."

The strength of the magnetic field varies across the Sun's surface, with the strongest fields occurring in sunspots, where it can reach thousands of gauss, compared to the average field strength of about 1 gauss. The magnetic field is also stronger in active regions, which are areas of concentrated magnetic flux. Active regions are often associated with solar flares and coronal mass ejections, which are large eruptions of plasma and magnetic field from the Sun's corona. These eruptions can cause geomagnetic storms on Earth, which can disrupt satellite communications and power grids.

One of the most significant aspects of the Sun's magnetic field is the solar cycle, an approximately 11-year cycle in which the Sun's magnetic field flips polarity. This cycle is associated with the periodic increase and decrease in the number of sunspots and in solar activity levels. The solar cycle is driven by the winding up and subsequent reconfiguration of the Sun's magnetic field lines due to the Sun's differential rotation, a process known as the solar dynamo.

The study of the Sun's magnetic field is not only important for understanding the Sun itself, but also for predicting space weather, which can affect satellite communications, power grids, and astronauts in space. It also provides a laboratory for studying fundamental plasma physics processes that are relevant to other astrophysical contexts, such as other stars and accretion disks around black holes.

## 3.5. Stellar models and Hertzsprung-Russell Diagram
...
### 3.5.1. Hertzsprung-Russell Diagram
