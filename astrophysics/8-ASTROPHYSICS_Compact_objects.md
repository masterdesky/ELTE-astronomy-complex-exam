# 8. Compact objects
Compact objects are a class of astronomical objects characterized by their high density. They include white dwarfs, neutron stars, and black holes. These objects are of immense interest to astrophysicists due to the extreme physical conditions they represent.
## 8.1. Mathematical and physical description
The mathematical and physical description of compact objects is governed by the principles of general relativity and quantum mechanics. Two of the most important components of this description are the equation of state (EoS) and the Tolman–Oppenheimer–Volkoff (TOV) equations.

### 8.1.1. Equation of State
The EoS is a mathematical relationship that describes how the pressure of a substance depends on its density. For example, the EoS for an ideal gas is $P = \varrho k_{B} T / m$, where $P$ is the pressure, $\varrho$ is the density, $k_{B}$ is the Boltzmann constant, $T$ is the temperature, and $m$ is the mass of a single particle. This equation tells us that the pressure of an ideal gas is proportional to its density.

It is also a key component in the study of compact objects, as it defines the relationship between the pressure, density, and temperature within these objects, the most important physical characteristics governing their structure and evolution. The EoS plays a crucial role in determining the properties and the evolution of compact objects.

Different forms of degenerate matter (e.g., electron-degenerate matter in white dwarfs, neutron-degenerate matter in neutron stars) will have different equations of state. The precise form of the EoS for these types of matter is an area of ongoing research, as it depends on the details of the strong nuclear force and quantum mechanics at high densities.

### 8.1.2. Tolman–Oppenheimer–Volkoff Equations
The TOV equations are solutions to Einstein's field equations of general relativity, which describe the structure of a spherically symmetric, non-rotating, static body as follows:
...
They are essentially the general relativistic extension of the classical equations of hydrostatic equilibrium, which balance the inward pull of gravity against the outward push of pressure.

In the context of compact objects, the TOV equations describe how the pressure and density of the object vary with distance from the center. The EoS is an input to these equations, and by solving them one can determine the structure of the object, such as its mass and radius.

Together, the EoS and the TOV equations provide a comprehensive mathematical and physical framework for understanding the properties and behavior of compact objects. While the details can be quite complex and involve a deep understanding of both general relativity and quantum mechanics, the basic principles are rooted in these two foundational components.
...
2. **Kerr Black Holes**: Most black holes in the universe are expected to be rotating, and these are described by the Kerr solution to Einstein's field equations, named after Roy P. Kerr who found the solution in 1963. These black holes are characterized by both their mass and their spin. The spin of a Kerr black hole drags nearby spacetime around with it, an effect known as frame-dragging. This leads to the existence of the ergosphere, a region outside the event horizon where objects cannot remain stationary.
